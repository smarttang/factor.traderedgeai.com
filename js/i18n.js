  ...
  var LANG = {
    ...
    factors: {
      zh: {
        ...
        factor_choppiness_sub: 'Choppiness 震荡指数', factor_choppiness_desc: '基于 ATR 与 HL 区间的震荡程度 0~100。',
        factor_realized_volatility_sub: '已实现波动率', factor_realized_volatility_desc: '对数收益平方和，历史波动估计。',
        factor_variance_ratio_sub: '方差比', factor_variance_ratio_desc: 'VR(q) 检验均值回归与趋势持续性。',
        factor_aroon_sub: 'Aroon 振荡器', factor_aroon_desc: 'AroonUp/AroonDown，趋势强度与转折。',
        factor_vwap_deviation_sub: 'VWAP 偏离', factor_vwap_deviation_desc: '价格相对 VWAP 的偏离度。',
        factor_bbsqueeze_sub: '布林带宽收缩', factor_bbsqueeze_desc: 'BB 带宽分位数，收缩后突破。',
        factor_garman_klass_sub: 'Garman-Klass 波动率', factor_garman_klass_desc: 'OHLC 估计波动率。',
        factor_parkinson_sub: 'Parkinson 波动率', factor_parkinson_desc: '基于 High-Low 的波动估计。',
        factor_yangzhang_sub: 'Yang-Zhang 波动率', factor_yangzhang_desc: 'OHLC 隔夜与日内波动。',
        factor_realized_skewness_sub: '已实现偏度', factor_realized_skewness_desc: '收益三阶矩，分布偏度。',
        factor_realized_kurtosis_sub: '已实现峰度', factor_realized_kurtosis_desc: '收益四阶矩，尾部厚度。',
        factor_volatility_cone_sub: '波动率锥', factor_volatility_cone_desc: 'RV 历史分位数，当前波动所处区间。',
        factor_linear_regression_slope_sub: '线性回归斜率', factor_linear_regression_slope_desc: '收盘价回归斜率/ATR。',
        factor_ou_params_sub: 'OU 参数', factor_ou_params_desc: 'Ornstein-Uhlenbeck φ 与半衰期，均值回归速度。',
        factor_autocorrelation_sub: '自相关', factor_autocorrelation_desc: '收益滞后 k 期自相关 AC(k)。',
        factor_bbkc_squeeze_sub: 'BB-KC 挤压', factor_bbkc_squeeze_desc: '布林带进 KC 通道，收缩突破。',
        factor_price_acceleration_sub: '价格加速度', factor_price_acceleration_desc: '收盘二阶差分，加速度动量。',
        factor_volume_roc_sub: '成交量变化率', factor_volume_roc_desc: '成交量 ROC，放量缩量。',
        factor_frama_sub: 'FRAMA', factor_frama_desc: '分形自适应移动平均。',
        factor_hma_sub: 'Hull MA', factor_hma_desc: 'WMA 组合，低滞后均线。',
        factor_tick_intensity_sub: 'Tick 强度', factor_tick_intensity_desc: '成交量/均量，活跃度。',
        factor_tick_run_sub: 'Tick 同向连续', factor_tick_run_desc: '同向连续 K 线长度。',
        factor_trade_clustering_sub: '交易聚类', factor_trade_clustering_desc: '近期量/历史量比，聚类强度。',
        factor_jma_sub: 'Jurik MA 近似', factor_jma_desc: '双 EMA 近似 Jurik 均线。',
        factor_adxroc_sub: 'ADX+ROC', factor_adxroc_desc: 'ADX 与方向变化率组合。',
        factor_rmi_sub: '相对动量指数', factor_rmi_desc: '动量+RSI 混合。',
        factor_overreaction_sub: '过度反应', factor_overreaction_desc: 'Move/ATR，超买超卖程度。',
        factor_adline_sub: '累积/派发线', factor_adline_desc: 'MFM×Volume 累积。',
        factor_vwmacd_sub: '成交量加权 MACD', factor_vwmacd_desc: 'VWMA 快慢线差。',
        factor_nvi_sub: '负成交量指数', factor_nvi_desc: '缩量日累积。',
        factor_pvi_sub: '正成交量指数', factor_pvi_desc: '放量日累积。',
        factor_vpt_sub: '成交量价格趋势', factor_vpt_desc: 'Volume×ROC 累积。',
        factor_engulf_strength_sub: '吞没形态强度', factor_engulf_strength_desc: 'Body/Volume 吞没强度。',
        factor_pinbar_sub: 'Pin Bar', factor_pinbar_desc: '影线/实体，反转形态。',
        factor_insidebar_sub: 'Inside Bar 突破', factor_insidebar_desc: '内包线突破。',
        factor_roundlevel_sub: '关键价位', factor_roundlevel_desc: '整数关口/ATR 接近度。',
        factor_pricegap_sub: '价格缺口', factor_pricegap_desc: '周末缺口/ATR。',
        factor_consecutivebars_sub: '连续 K 线', factor_consecutivebars_desc: '同向连续根数。',
        factor_londonmomentum_sub: '伦敦开盘动量', factor_londonmomentum_desc: 'Lookback 动量。',
        factor_nybreakout_sub: '纽约开盘突破', factor_nybreakout_desc: '区间突破。',
        factor_asianrange_sub: '亚盘区间', factor_asianrange_desc: '亚盘区间突破。',
        factor_weekdayeffect_sub: '周内效应', factor_weekdayeffect_desc: '星期收益效应。',
        factor_monthlyseasonality_sub: '月度季节性', factor_monthlyseasonality_desc: '月份收益效应。',
        factor_fixprice_sub: '定盘价', factor_fixprice_desc: '定盘前后收益修正。',
        factor_priceentropy_sub: '价格熵', factor_priceentropy_desc: '收益分 bin 熵，低熵跟趋势。',
        factor_lzcomplexity_sub: 'LZ 复杂度', factor_lzcomplexity_desc: '收益符号 LZ78 复杂度。',
        factor_pcafactor_sub: 'PCA 主成分', factor_pcafactor_desc: '多特征 PC1 投影。',
        factor_aeresidual_sub: '自编码器残差', factor_aeresidual_desc: 'c-MA 大残差均值回归。',
        factor_clusterstate_sub: '聚类状态', factor_clusterstate_desc: 'K=2 聚类簇均收益。',
        factor_largeorder_sub: '大单检测', factor_largeorder_desc: '成交量异常+价格方向。',
        factor_garchvolatility_sub: 'GARCH 波动率', factor_garchvolatility_desc: 'GARCH(1,1) σ²，波动变化。',
        factor_quantileregression_sub: '分位数回归', factor_quantileregression_desc: '时间对收盘斜率。',
        factor_trendfollowcombo_sub: '趋势跟踪组合 C1', factor_trendfollowcombo_desc: '动量+突破组合。',
        factor_meanreversioncombo_sub: '均值回归组合 C2', factor_meanreversioncombo_desc: 'c-MA 偏离组合。',
        factor_breakoutcombo_sub: '突破组合 C3', factor_breakoutcombo_desc: '突破近期高低。',
        factor_arbitragecombo_sub: '套利组合 C4', factor_arbitragecombo_desc: 'ECT=c-MA 均值回归。',
        factor_marketmakingcombo_sub: '做市组合 C5', factor_marketmakingcombo_desc: '(2c-hi-lo)/range 均值回归。',
        factor_timeframecombo_sub: '时间框架组合 C6', factor_timeframecombo_desc: '短5/长20 动量对齐。',
        factor_statecombo_sub: '市场状态组合 C7', factor_statecombo_desc: 'ATR 高低波动+低波动动量。',
        factor_fusionweights_sub: '信号融合 C8', factor_fusionweights_desc: '动量+均值回归+突破三信号融合。',
        pagination_prev: '上一页', pagination_next: '下一页', pagination_page: '第 {n} 页', pagination_of: '共 {total} 页',
        filter_group_type: '接口类型', tag_unified: '统一接口', tag_standalone: '独立 API',
        factors_count: '共 {n} 个因子',
      ...
      en: {
        ...
        factor_choppiness_sub: 'Choppiness Index', factor_choppiness_desc: 'Choppiness 0~100 from ATR and HL range.',
        factor_realized_volatility_sub: 'Realized volatility', factor_realized_volatility_desc: 'Sum of squared log returns.',
        factor_variance_ratio_sub: 'Variance ratio', factor_variance_ratio_desc: 'VR(q) for mean reversion vs trend.',
        factor_aroon_sub: 'Aroon oscillator', factor_aroon_desc: 'AroonUp/AroonDown, trend strength.',
        factor_vwap_deviation_sub: 'VWAP deviation', factor_vwap_deviation_desc: 'Price deviation from VWAP.',
        factor_bbsqueeze_sub: 'BB squeeze', factor_bbsqueeze_desc: 'BB bandwidth percentile, squeeze breakout.',
        factor_garman_klass_sub: 'Garman-Klass volatility', factor_garman_klass_desc: 'OHLC volatility estimator.',
        factor_parkinson_sub: 'Parkinson volatility', factor_parkinson_desc: 'High-Low based volatility.',
        factor_yangzhang_sub: 'Yang-Zhang volatility', factor_yangzhang_desc: 'OHLC overnight and intraday vol.',
        factor_realized_skewness_sub: 'Realized skewness', factor_realized_skewness_desc: 'Third moment of returns.',
        factor_realized_kurtosis_sub: 'Realized kurtosis', factor_realized_kurtosis_desc: 'Fourth moment of returns.',
        factor_volatility_cone_sub: 'Volatility cone', factor_volatility_cone_desc: 'RV historical percentile.',
        factor_linear_regression_slope_sub: 'Linear regression slope', factor_linear_regression_slope_desc: 'Close slope/ATR.',
        factor_ou_params_sub: 'OU params', factor_ou_params_desc: 'Ornstein-Uhlenbeck φ and half-life.',
        factor_autocorrelation_sub: 'Autocorrelation', factor_autocorrelation_desc: 'Lag-k autocorrelation of returns.',
        factor_bbkc_squeeze_sub: 'BB-KC squeeze', factor_bbkc_squeeze_desc: 'BB inside KC channel, squeeze breakout.',
        factor_price_acceleration_sub: 'Price acceleration', factor_price_acceleration_desc: 'Second difference of closes.',
        factor_volume_roc_sub: 'Volume ROC', factor_volume_roc_desc: 'Volume rate of change.',
        factor_frama_sub: 'FRAMA', factor_frama_desc: 'Fractal adaptive moving average.',
        factor_hma_sub: 'Hull MA', factor_hma_desc: 'WMA combination, low-lag MA.',
        factor_tick_intensity_sub: 'Tick intensity', factor_tick_intensity_desc: 'Volume vs average volume.',
        factor_tick_run_sub: 'Tick run', factor_tick_run_desc: 'Consecutive same-direction bars.',
        factor_trade_clustering_sub: 'Trade clustering', factor_trade_clustering_desc: 'Recent vs historical volume ratio.',
        factor_jma_sub: 'Jurik MA approx', factor_jma_desc: 'Dual EMA approx of Jurik MA.',
        factor_adxroc_sub: 'ADX+ROC', factor_adxroc_desc: 'ADX and rate of change.',
        factor_rmi_sub: 'Relative Momentum Index', factor_rmi_desc: 'Momentum + RSI hybrid.',
        factor_overreaction_sub: 'Overreaction', factor_overreaction_desc: 'Move/ATR, overbought/oversold.',
        factor_adline_sub: 'A/D line', factor_adline_desc: 'MFM×Volume accumulation.',
        factor_vwmacd_sub: 'VW MACD', factor_vwmacd_desc: 'VWMA fast minus slow.',
        factor_nvi_sub: 'Negative Volume Index', factor_nvi_desc: 'Accumulation on down volume.',
        factor_pvi_sub: 'Positive Volume Index', factor_pvi_desc: 'Accumulation on up volume.',
        factor_vpt_sub: 'Volume Price Trend', factor_vpt_desc: 'Volume×ROC accumulation.',
        factor_engulf_strength_sub: 'Engulf strength', factor_engulf_strength_desc: 'Body/Volume engulf strength.',
        factor_pinbar_sub: 'Pin Bar', factor_pinbar_desc: 'Wick/body, reversal pattern.',
        factor_insidebar_sub: 'Inside Bar breakout', factor_insidebar_desc: 'Inside bar breakout.',
        factor_roundlevel_sub: 'Round level', factor_roundlevel_desc: 'Distance to round number/ATR.',
        factor_pricegap_sub: 'Price gap', factor_pricegap_desc: 'Weekend gap/ATR.',
        factor_consecutivebars_sub: 'Consecutive bars', factor_consecutivebars_desc: 'Same-direction bar count.',
        factor_londonmomentum_sub: 'London momentum', factor_londonmomentum_desc: 'Lookback momentum.',
        factor_nybreakout_sub: 'NY breakout', factor_nybreakout_desc: 'Range breakout.',
        factor_asianrange_sub: 'Asian range', factor_asianrange_desc: 'Asian session range breakout.',
        factor_weekdayeffect_sub: 'Weekday effect', factor_weekdayeffect_desc: 'Day-of-week return effect.',
        factor_monthlyseasonality_sub: 'Monthly seasonality', factor_monthlyseasonality_desc: 'Month return effect.',
        factor_fixprice_sub: 'Fix price', factor_fixprice_desc: 'Pre/post fix return adjustment.',
        factor_priceentropy_sub: 'Price entropy', factor_priceentropy_desc: 'Return bin entropy, low entropy follow trend.',
        factor_lzcomplexity_sub: 'LZ complexity', factor_lzcomplexity_desc: 'LZ78 complexity of return signs.',
        factor_pcafactor_sub: 'PCA factor', factor_pcafactor_desc: 'PC1 projection of features.',
        factor_aeresidual_sub: 'AE residual', factor_aeresidual_desc: 'c-MA large residual mean reversion.',
        factor_clusterstate_sub: 'Cluster state', factor_clusterstate_desc: 'K=2 cluster mean return.',
        factor_largeorder_sub: 'Large order', factor_largeorder_desc: 'Volume anomaly + price direction.',
        factor_garchvolatility_sub: 'GARCH volatility', factor_garchvolatility_desc: 'GARCH(1,1) σ².',
        factor_quantileregression_sub: 'Quantile regression', factor_quantileregression_desc: 'Time vs close slope.',
        factor_trendfollowcombo_sub: 'Trend follow combo C1', factor_trendfollowcombo_desc: 'Momentum + breakout.',
        factor_meanreversioncombo_sub: 'Mean reversion combo C2', factor_meanreversioncombo_desc: 'c-MA deviation.',
        factor_breakoutcombo_sub: 'Breakout combo C3', factor_breakoutcombo_desc: 'Break recent high/low.',
        factor_arbitragecombo_sub: 'Arbitrage combo C4', factor_arbitragecombo_desc: 'ECT=c-MA mean reversion.',
        factor_marketmakingcombo_sub: 'Market making combo C5', factor_marketmakingcombo_desc: '(2c-hi-lo)/range mean reversion.',
        factor_timeframecombo_sub: 'Timeframe combo C6', factor_timeframecombo_desc: 'Short5/long20 momentum align.',
        factor_statecombo_sub: 'State combo C7', factor_statecombo_desc: 'ATR high/low vol + low vol momentum.',
        factor_fusionweights_sub: 'Fusion weights C8', factor_fusionweights_desc: 'Momentum + mean reversion + breakout fusion.',
        pagination_prev: 'Previous', pagination_next: 'Next', pagination_page: 'Page {n}', pagination_of: 'of {total}',
        filter_group_type: 'API type', tag_unified: 'Unified', tag_standalone: 'Standalone API',
        factors_count: '{n} factors',
